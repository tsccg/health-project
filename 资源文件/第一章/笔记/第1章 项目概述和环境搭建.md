...
![image-20200515091125518](img/image-20200515091125518.png)
...
![image-20200408125741297](img/image-20200408125741297.png)
...
**注意**：将资料中的maven仓库repository_boot覆盖自己的仓库。

#### 2.2.1 health_parent

创建空的总体大工程 itcast_health

![image-20200408130448296](img/image-20200408130448296.png)

创建health_parent，父工程，打包方式为pom，用于统一管理依赖版本

![image-20200408130613280](img/image-20200408130613280.png)

![image-20200408130853217](img/image-20200408130853217.png)
...
![image-20200408132502202](img/image-20200408132502202.png)
...
![image-20200408132925057](img/image-20200408132925057.png)
...
![image-20200408133450881](img/image-20200408133450881.png)

![image-20200408133311856](img/image-20200408133311856.png)

若maven中此项目为灰色，则手动添加入模块。

![image-20200408133722265](img/image-20200408133722265.png)
...
![image-20200408133934632](img/image-20200408133934632.png)

resources下放入以下文件：

<img src="img/image-20200408134717422.png" alt="image-20200408134717422" style="zoom:80%;" />
...
log4j.appender.file.File=d:\\mylog\\provider.log
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <!--批量扫描，发布服务-->
    <dubbo:annotation package="com.tsccg.service"/>
</beans>
```
...
本地mysql新建数据库 health,注意编码

![image-20200408134414684](img/image-20200408134414684.png)

#### 2.2.7 health_backend

创建health_backend，子工程，打包方式为war，单独部署，存放Controller、页面等

![image-20200408134809985](img/image-20200408134809985.png)

![image-20200408134840685](img/image-20200408134840685.png)
...
![image-20200408135356085](img/image-20200408135356085.png)
...
### direct messages to file mylog.log ###
log4j.appender.file=org.apache.log4j.FileAppender
log4j.appender.file.File=d:\\mylog\\backend.log
log4j.appender.file.layout=org.apache.log4j.PatternLayout
log4j.appender.file.layout.ConversionPattern=%d{ABSOLUTE} %5p %c{1}:%L - %m%n
...
![image-20200408144138542](img/image-20200408144138542.png)
...
测试：backend工程中创建文件elementuidemo\01-container.html
...
![image-20200408144311955](img/image-20200408144311955.png)
