...
![image-20200526091510523](img/image-20200526091510523.png)
...
页面中使用DatePicker控件来展示日历。根据需求，最多可以提前一个月进行体检预约，所以日历控件只展示未来一个月的日期。**页面已有**。
...
在OrderController中提供findById方法，根据预约id查询预约相关信息。**注意返回类型为map**
...
![image-20200528085653152](img/image-20200528085653152.png)
